...
function init_threeScene(spec) {
  ...
  async function apiData() {
    ...
    var detection_point ="head";
    var web_url;
    var contentAsset = "";
    var content = "/heart_glasses.glb";
    ...
    // ********************* head detection point *************************************
      ...
      loader.load(
        ...
        function (gltf) {
          ...
          if (experience[0].place_head == "place_head") {
          ...
          } else if (experience[0].place_head == "above_head") {
